...
const products: Product[] = [
  {
    ...
    image_link: "/assets/images/products/kit-6-treatments-front.webp",
    ...
    images: [
      "/assets/images/products/kit-6-treatments-front.webp"
    ],
    brand: "Leger Lab",
    rating: 4.8,
    reviewCount: 156
  },
  {
    ...
    price: 24.99,
    link: RoutePath.ORDER,
    image_link: "/assets/images/products/kit-1-treatment-front.webp",
    availability: "in stock",
    sku: "LEGER-KIT-01",
    ...
    images: [
      "/assets/images/products/kit-1-treatment-front.webp"
    ],
    brand: "Leger Lab",
    rating: 4.7,
    reviewCount: 89
  },
  {
    ...
    price: 29.99,
    link: RoutePath.ORDER,
    image_link: "/assets/images/products/refill-500ml.webp",
    availability: "in stock",
    ...
    images: [
      "/assets/images/products/refill-500ml.webp"
    ],
    brand: "Leger Lab",
    rating: 4.9,
    reviewCount: 203
