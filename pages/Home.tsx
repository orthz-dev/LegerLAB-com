    ...
    >
      <main className="overflow-x-hidden font-lato">
        ...
        <section
          ...
          style={{
            backgroundImage: `url('/assets/images/banners/hero-background.webp')`,
        ...
        <section className="py-20 bg-white">
          <div className="max-w-[1120px] mx-auto px-4 md:px-10">
            <div className="flex flex-col items-center text-center mb-12">
              <img src="/assets/images/icons/stars-decoration.webp" alt="Stars" className="w-[70px] mb-6" />
        ...
        <section className="py-10 md:py-20 bg-white">
          <div className="max-w-[1120px] mx-auto px-4 md:px-10 grid md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1">
              <img src="/assets/images/features/benefits-badges.webp" alt="Benefits" className="w-[320px] mx-auto md:mx-0 mb-8" />
            ...
            <div className="order-1 md:order-2">
              <img src="/assets/images/banners/leger-experience.webp" alt="Leger Experience" className="w-full max-w-[800px]" />
            </div>
          </div>
        </section>
            ...
            <div>
              ...
              <div className="flex gap-4">
                <a href="https://www.instagram.com/legerlab_official/" target="_blank" rel="noreferrer">
                  <img src="/assets/images/logos/social/instagram-icon.webp" alt="Instagram" className="w-10" />
                </a>
                <a href="https://www.facebook.com/profile.php?id=61550876933299" target="_blank" rel="noreferrer">
                  <img src="/assets/images/logos/social/facebook-icon.webp" alt="Facebook" className="w-10" />
                </a>
              </div>
            </div>
            <div className="flex justify-center">
              <img src="/assets/images/logos/social/instagram-3d.webp" alt="Instagram 3D" className="w-full max-w-[500px]" />
            </div>
          </div>
        </section>
        ...
        <section className="py-10 bg-brand-soft relative overflow-hidden">
          <div className="max-w-[1120px] mx-auto px-4 md:px-10 flex flex-col md:flex-row items-center">
            <div className="w-full md:w-1/2 mb-8 md:mb-0 relative z-10">
              <img src="/assets/images/banners/legs-promo.webp" alt="Legs" className="w-full max-w-[600px]" />
            </div>
        ...
        <section className="py-12 bg-white">
          <div className="max-w-[1120px] mx-auto px-4 md:px-10 grid grid-cols-2 gap-8 justify-items-center">
            <div className="flex flex-col items-center">
              <img src="/assets/images/icons/shipping-free.webp" alt="Spedizione Gratuita" className="w-[100px] mb-4" />
              <p className="text-[16px] text-brand-strong">Spedizione gratuita</p>
            </div>
            <div className="flex flex-col items-center">
              <img src="/assets/images/icons/shipping-fast.webp" alt="Spedizione Veloce" className="w-[100px] mb-4" />
