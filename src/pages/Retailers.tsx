      ...
      <main className="bg-white font-lato overflow-x-hidden">
         ...
         <section className="py-12 md:py-20 px-4 md:px-10">
            <div className="max-w-[1120px] mx-auto grid md:grid-cols-2 gap-12 items-center">
               <div>
                  <img src={IMAGES.icons.store} className="w-[120px] mb-6" alt="Store Icon" />
               ...
               <div className="flex justify-center">
                  <img src={IMAGES.banners.storeImage} className="w-full max-w-[540px]" alt="Store" />
               </div>
            </div>
         </section>
            ...
            <div className="max-w-[1120px] mx-auto px-4 md:px-10">
               <div className="grid md:grid-cols-2 gap-12 items-center">
                  <div className="order-2 md:order-1">
                     <img src={IMAGES.banners.partnerOffer} className="w-full max-w-[540px]" alt="Partner Offer" />
                  </div>
                  <div className="order-1 md:order-2">
                     <img src={IMAGES.icons.hands} className="w-[120px] mb-6" alt="Hands" />
         ...
         <section className="py-12 md:py-20 bg-white">
            <div className="max-w-[1120px] mx-auto px-4 md:px-10">
               <div className="grid md:grid-cols-2 gap-12 items-center">
                  <div>
                     <img src={IMAGES.banners.influencerPromo} className="w-full max-w-[564px]" alt="Influencer" />
                  </div>
                  <div>
                     <img src={IMAGES.icons.influencer} className="w-[120px] mb-6" alt="Icon" />
         ...
         <section className="py-12 md:py-20 bg-brand-soft/30">
            <div className="max-w-[1120px] mx-auto px-4 md:px-10 text-center">
               <img src={IMAGES.icons.stars} className="w-[71px] mx-auto mb-6" alt="Stars" />
               ...
               <div className="mt-12 p-8 bg-white rounded-2xl max-w-2xl mx-auto shadow-sm">
                  <img src={IMAGES.icons.stars} className="w-[50px] mx-auto mb-4" alt="Icon" />
